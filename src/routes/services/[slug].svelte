...
<script lang="ts" context="module">
	...
	export const load: Load = async ({ page: { params }, fetch }) => {
		...
		const res = await fetch('http://localhost:1337/services/' + slug);
...
<script lang="ts">
	...
	console.log('🚀 ~ file: [slug].svelte ~ line 29 ~ service', service);
	...
	<div class="container px-5 py-24 mx-auto">
		<div class="lg:w-4/5 mx-auto flex flex-wrap">
			...
			<div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
				<h2 class="text-sm title-font text-gray-500 tracking-widest">Servicio</h2>
				...
				<div class="flex">
					{#if service.price}
						<span class="title-font font-medium text-2xl text-gray-900">${service.price}</span>
					{:else}
						<span class="title-font font-medium text-2xl text-gray-900">no tiene precio aun</span>
					{/if}
					<button
